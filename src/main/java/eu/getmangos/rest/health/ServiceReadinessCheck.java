...
public class ServiceReadinessCheck implements HealthCheck {
    ...
    private static final String readinessCheck = AhBotResource.class.getSimpleName() + " Readiness Check";

    @Inject
    @ConfigProperty(name = "eu_getmangos_ahbot_service_inMaintenance")
